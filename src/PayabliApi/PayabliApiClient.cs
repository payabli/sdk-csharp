...
public partial class PayabliApiClient : IPayabliApiClient
{
    ...
    )
    {
        ...
        if (clientId != null && clientSecret != null)
        {
            ...
            clientOptionsWithAuth.AuthHeaderSchemes["BearerAuth"] = oauthAuthHeaders;
        }
        if (apiKey != null)
        {
            clientOptionsWithAuth.AuthHeaderSchemes["APIKeyAuth"] = new Headers(
        ...
        CaseManagement = new CaseManagementClient(_client);
    }
