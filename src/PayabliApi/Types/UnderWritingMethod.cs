...
[JsonConverter(typeof(UnderWritingMethod.UnderWritingMethodSerializer))]
[Serializable]
public readonly record struct UnderWritingMethod : IStringEnum
{
    ...
    internal class UnderWritingMethodSerializer : JsonConverter<UnderWritingMethod>
    {
        public override UnderWritingMethod Read(
        ...
        )
        {
            ...
            return new UnderWritingMethod(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            UnderWritingMethod value,
            JsonSerializerOptions options
        )
        {
        ...
        public override UnderWritingMethod ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
