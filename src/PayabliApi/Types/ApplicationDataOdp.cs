...
[Serializable]
public record ApplicationDataOdp : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required double PayoutAverageTicketAmount { get; set; }

    [JsonPropertyName("payoutCreditLimit")]
    public required double PayoutCreditLimit { get; set; }

    [JsonPropertyName("payoutHighTicketAmount")]
    public required double PayoutHighTicketAmount { get; set; }
