...
public class AddPayLinkFromInvoiceTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.PaymentLink.AddPayLinkFromInvoiceAsync(
            23548884,
    ...
    public async Task MockServerTest_2()
    {
        ...
        var response = await Client.PaymentLink.AddPayLinkFromInvoiceAsync(
            ...
            new PayLinkDataInvoice
            {
                Invoices = new InvoiceElement { Enabled = true },
                ContactUs = new ContactElement { Enabled = false },
            }
        );
        JsonAssert.AreEqual(response, mockResponse);
    }
