...
[TestFixture]
public class ExportBatchesOutOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/batchesOut/csv/org/123")
        ...
        var response = await Client.Export.ExportBatchesOutOrgAsync(
            ExportFormat1.Csv,
            123,
