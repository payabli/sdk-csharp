...
[TestFixture]
public class ExportSettlementsOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/settlements/csv/org/123")
        ...
        var response = await Client.Export.ExportSettlementsOrgAsync(
            ExportFormat1.Csv,
            123,
