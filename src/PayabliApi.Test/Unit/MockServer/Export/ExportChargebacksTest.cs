...
public class ExportChargebacksTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/chargebacks/csv/8cfec329267")
        ...
        var response = await Client.Export.ExportChargebacksAsync(
            ExportFormat1.Csv,
            "8cfec329267",
