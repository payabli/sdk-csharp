...
[TestFixture]
public class GetByIdLinkApplicationTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.Boarding.GetByIdLinkApplicationAsync(91);
        Assert.That(
            response,
