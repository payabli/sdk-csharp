...
[TestFixture]
public class GetPaymentMethodDomainTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        var response = await Client.PaymentMethodDomain.GetPaymentMethodDomainAsync(
            "pmd_b8237fa45c964d8a9ef27160cd42b8c5"
        );
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<PaymentMethodDomainApiResponse>(mockResponse))
                .UsingDefaults()
        );
    }
}
