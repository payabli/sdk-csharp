...
[TestFixture]
public class ExportSettlementsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/settlements/csv/8cfec329267")
        ...
        var response = await Client.Export.ExportSettlementsAsync(
            "8cfec329267",
            ExportFormat1.Csv,
