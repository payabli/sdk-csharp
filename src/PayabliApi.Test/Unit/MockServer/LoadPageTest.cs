...
[TestFixture]
public class LoadPageTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Paypoint/load/8cfec329267/pay-your-fees-1")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.HostedPaymentPages.LoadPageAsync(
            "8cfec329267",
            "pay-your-fees-1"
        );
        Assert.That(
