...
[TestFixture]
public class ListBatchesOutOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
              ...
              "Records": [
                {
                  ...
                  "BatchDate": "2024-01-01T00:00:00.000Z",
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Query/batchesOut/org/123")
        ...
        var response = await Client.Query.ListBatchesOutOrgAsync(
            123,
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<QueryBatchesOutResponse>(mockResponse)).UsingDefaults()
        );
    }
}
