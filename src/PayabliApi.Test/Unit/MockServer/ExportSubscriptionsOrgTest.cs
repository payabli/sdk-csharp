...
[TestFixture]
public class ExportSubscriptionsOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/subscriptions/csv/org/123")
        ...
        var response = await Client.Export.ExportSubscriptionsOrgAsync(
            ExportFormat1.Csv,
            123,
