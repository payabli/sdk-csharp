...
[TestFixture]
public class ExportTransactionsOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/transactions/csv/org/123")
        ...
        var response = await Client.Export.ExportTransactionsOrgAsync(
            ExportFormat1.Csv,
            123,
