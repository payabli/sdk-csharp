...
public class ListVcardsTransactionsTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Query/vcardsTransactions/8cfec329267")
        ...
        var response = await Client.Query.ListVcardsTransactionsAsync(
            "8cfec329267",
