...
[TestFixture]
public class ListVendorsOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Query/vendors/org/123")
        ...
        var response = await Client.Query.ListVendorsOrgAsync(
            123,
        ...
        Assert.That(
            response,
            Is.EqualTo(JsonUtils.Deserialize<QueryResponseVendors>(mockResponse)).UsingDefaults()
        );
    }
}
