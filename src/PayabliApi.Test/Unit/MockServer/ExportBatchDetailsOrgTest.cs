...
[TestFixture]
public class ExportBatchDetailsOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/batchDetails/csv/org/123")
        ...
        var response = await Client.Export.ExportBatchDetailsOrgAsync(
            ExportFormat1.Csv,
            123,
