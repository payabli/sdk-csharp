...
[TestFixture]
public class AddPayLinkFromBillLotNumberTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/PaymentLink/bill/lotNumber/LOT-2024-001")
                    .WithParam("entryPoint", "billing")
                    .WithParam("vendorNumber", "VENDOR-123")
        ...
        var response = await Client.PaymentLink.AddPayLinkFromBillLotNumberAsync(
            "LOT-2024-001",
            new PayLinkDataOut
            {
                EntryPoint = "billing",
