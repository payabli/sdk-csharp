...
[TestFixture]
public class GetByTemplateIdLinkApplicationTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Boarding/linkbyTemplate/80")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Boarding.GetByTemplateIdLinkApplicationAsync(80);
        Assert.That(
            response,
