...
[TestFixture]
public class ExportChargebacksOrgTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/Export/chargebacks/csv/org/123")
        ...
        var response = await Client.Export.ExportChargebacksOrgAsync(
            ExportFormat1.Csv,
            123,
