...
[TestFixture]
public class TransferQueryResponseTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new TransferQueryResponse
        {
            Records = new List<Transfer>()
            {
                new Transfer
                {
                    TransferId = 79851,
        ...
        var deserializedObject = JsonUtils.Deserialize<TransferQueryResponse>(json);
    ...
    public void TestSerialization()
    {
        var expectedJson = """
            ...
            """;
        var actualObj = new TransferQueryResponse
        {
            Records = new List<Transfer>()
            {
                new Transfer
