...
[TestFixture]
public class PaymentPageRequestBodyTest
{
    ...
    public void TestDeserialization_1()
    {
        var json = """
            ...
            """;
        var expectedObject = new PaymentPageRequestBody
        {
        ...
        var deserializedObject = JsonUtils.Deserialize<PaymentPageRequestBody>(json);
    ...
    public void TestSerialization_1()
    {
        var expectedJson = """
            ...
            """;
        var actualObj = new PaymentPageRequestBody
        {
            ContactUs = new ContactElement
            {
                EmailLabel = "Email",
